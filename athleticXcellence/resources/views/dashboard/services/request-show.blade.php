...
<head>
    ...
    <title>Service Request Details | ATHLETICXCELLENCE</title>
                ...
                <div class="bg-white shadow rounded-lg p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        ...
                        <div>
                            ...
                            <div class="space-y-3">
                                <p><span class="font-medium">Name:</span> {{ $request->first_name }} {{ $request->last_name }}</p>
                        ...
                        <div>
                            ...
                            <div class="space-y-3">
                                <p>
                                    ...
                                    <span class="capitalize">{{ str_replace('-', ' ', $request->project_type) }}</span>
                                </p>
                                <p>
                                    <span class="font-medium">Budget:</span> 
                                    {{ $request->budget ? str_replace('k', ',000', $request->budget) : 'Not specified' }}
                                </p>
                                <p>
                    ...
                    <!-- Project Description -->
                    <div class="mb-8">
                        <h3 class="text-lg font-semibold mb-4 border-b pb-2">Project Description</h3>
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <p class="whitespace-pre-line">{{ $request->project_details }}</p>
                        </div>
                    </div>
                    
                    <!-- Actions -->
                    <div class="flex justify-between items-center">
                        <a href="{{ route('admin.service-requests') }}" class="inline-flex items-center px-4 py-2 bg-gray-200 text-gray-800 rounded hover:bg-gray-300">
                            <i class="fas fa-arrow-left mr-2"></i> Back to List
                        </a>
                        
                        <form action="{{ route('admin.service-requests.update-status', $request) }}" method="POST">
                            @csrf
                            @method('PATCH')
                            <div class="flex items-center space-x-4">
