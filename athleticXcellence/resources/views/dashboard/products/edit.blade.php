...
<head>
    ...
    <title>Edit Product | ATHLETICXCELLENCE</title>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="description" id="description" rows="4"
                                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent">{{ $product->description }}</textarea>
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                @if($product->image_path)
                                    <div class="mt-3 flex items-center space-x-4">
                                        <img src="{{ asset('storage/' . $product->image_path) }}" alt="Current Image" class="h-20 w-20 object-cover rounded-md border border-gray-200">
