<nav class="fixed top-0 left-0 w-full flex items-center justify-between px-10 py-4 bg-black/80 backdrop-blur-sm z-50 border-b border-gray-800">
    ...
    <div class="flex space-x-8 text-lg">
        ...
        <a href="#" class="text-white hover:text-gray-300 transition-colors">Prices</a>
    </div>
        ...
        @auth
            ...
            <div class="relative" x-data="{ openCart: false }">
                <button @click="openCart = !openCart" class="p-2 text-white hover:text-gray-300 transition-colors relative">
                    ...
                    <span class="absolute -top-1 -right-1 bg-white text-black rounded-full w-5 h-5 flex items-center justify-center text-xs font-bold">3</span>
                </button>
                ...
                <div x-show="openCart" @click.away="openCart = false" 
                     ...
                     class="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-xl z-20 border border-gray-200 overflow-hidden">
                    ...
                    <div class="divide-y divide-gray-200 max-h-96 overflow-y-auto">
                        ...
                        <div class="p-4 flex items-center hover:bg-gray-50 transition-colors">
                            <div class="flex-shrink-0 h-16 w-16 bg-gray-200 rounded-md overflow-hidden">
                                <img src="https://via.placeholder.com/150" alt="Product" class="h-full w-full object-cover">
                            </div>
                            <div class="ml-4 flex-1">
                                <div class="flex justify-between">
                                    <h4 class="text-sm font-medium text-gray-900">Training Program</h4>
                                    <p class="text-sm font-medium text-gray-900">$99.99</p>
                                </div>
                                <div class="flex justify-between mt-2">
                                    <div class="flex items-center border border-gray-300 rounded-md">
                                        <button class="px-2 py-1 text-gray-600 hover:text-black">-</button>
                        ...
                        <div class="p-4 flex items-center hover:bg-gray-50 transition-colors">
                            ...
                            <div class="ml-4 flex-1">
                                <div class="flex justify-between">
                                    <h4 class="text-sm font-medium text-gray-900">Protein Powder</h4>
                    ...
                    <div class="p-4 border-t border-gray-200 bg-gray-50">
                        <div class="flex justify-between mb-4">
                            ...
                            <span class="font-medium">$199.97</span>
                        </div>
            ...
            <div class="relative" x-data="{ openUser: false }">
                ...
                <div x-show="openUser" @click.away="openUser = false"
                     ...
                     x-transition:leave-start="opacity-100 translate-y-0"
                     x-transition:leave-end="opacity-0 translate-y-1"
                     class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg z-20 border border-gray-200 overflow-hidden">
